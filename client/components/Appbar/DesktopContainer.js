          ...
          <Segment inverted textAlign='center' style={{ minHeight: 300, padding: '1em 0em' }} vertical>
            ...
            >
              <Container>
                ...
                <Menu.Item name='/products' as={Link} to='/products' active={activeItem === '/products'} onClick={this.handleItemClick}>Products</Menu.Item>
                <Menu.Item name='/devices' as={Link} to="/devices" active={activeItem === '/devices'} onClick={this.handleItemClick}>Devices</Menu.Item>
